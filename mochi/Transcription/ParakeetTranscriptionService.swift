...
final class ParakeetTranscriptionService: TranscriptionService {
	...
	private let logger = Logger(subsystem: "com.matteofari.mochi", category: "ParakeetService")
...
private enum ParakeetClipPadder {
	private static let logger = Logger(subsystem: "com.matteofari.mochi", category: "ParakeetPadder")
